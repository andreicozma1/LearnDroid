package com.example.android.testinglists;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        my_list = (LinearLayout) findViewById(R.id.list_view);
        addViews();
    }
    ...
    public void addViews() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            TextView v = (TextView) getLayoutInflater().inflate(R.layout.view, null);
